...
<body class="animsition">
			...
			<div class="container-fluid">
				<div class="fontawesome-list-wrap">
					...
					<section>
						...
						<p>Este estágio será o contrato que você fará com o prestador
							de serviço, tendo em vista que se você concordar(Clicando no
							botão avançar) em contratá-lo você não podera mais cancelar este
							pedido ou tentar excluir sua conta do sistema, pois você está se
							responsabilizando em contrata-lo. Obs.: Só avance para o próximo
							estágio se você realmente tiver certeza que irá querer contratar
							este colaborador, caso contrário cancele este pedido.</p>
						<br>

						<div class="row form-group col-md-12" >
							<div class="col-md-12">
								<button id="btnCancelar" style="width:100%" type="button" class="btn btn-danger">
						...
						<div class="row form-group" style="float: right;">
							<div class="col col-md-3">
								<button type="button" id="btnEnviar"
									...
									&nbsp;<i class="fas fa-forward"></i> Aceitar
								</button>
							</div>
						</div>
	...
	$('#btnEnviar').on('click', function(){
		 ...
		 swal({
			  title: "Você tem certeza que quer aceitar esse contrato?",
			  text:"",
			  icon: "warning",
			  buttons:true,
			  dangerMode: true,
			  ...
			  if (willDelete) {
				  ...
				  $.post('cancelarContrato', {
			           cas:'${contrato.solicitacao.idSolicitacaoContrato}',
						...
						swal("Contrato cancelado com sucesso!", {
						      icon: "success",
						    });
