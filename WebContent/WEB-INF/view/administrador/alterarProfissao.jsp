				...
				<div class="row">
					<div class="col-md-12">
                       <div><center>${msg}</center></div>
						<form action="updateProfissao" method="post" >
							<div class="card">
								<div class="card-header">
									<strong>Especialização -</strong> <small> Formulario de
										Alteração</small>
								</div>
								...
								<div class="card-body card-block">
									<div class="form-group">
										<label for="nome" class=" form-control-label">Nome</label> <input
											type="text" id="nome" name="nome" placeholder="Digite o nome da profissao"
											class="form-control" required="required" value="${profissao.nome}">
									</div>

									<div class="form-group ">
										<label for="descricao" class=" form-control-label">Descrição</label> 
										
                                           <textarea  required="required" name="descricao" id="descricao"  placeholder="Digite aqui..." class="form-control">${profissao.descricao}</textarea>
