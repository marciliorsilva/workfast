						...
						<form action="salvarServico" method="post" >
							<div class="card">
								<div class="card-header">
									<strong>Servico -</strong> <small> Formulario de
										Cadastro</small>
								</div>
								<div class="card-body card-block">
									...
									<div class="form-group ">
										<label>Categoria</label> <select required="required"
											...
											<c:forEach items="${listarCategoriaServico}" var="obj">
									...
									<div class="form-group">
										<label for="nome" class=" form-control-label">Nome</label> <input
											type="text" id="nome" name="nome" placeholder="Digite o nome do servico"
											class="form-control" value="${servico.nome}" required="required">
									</div>
	...
	<script
	 ...
	 <script> 
	  $(document).ready(function(){
		  $('#categoria').val("${servico.categoriaServico.nome}");
	  });
	 </script>
</body>
