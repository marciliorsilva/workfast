		...
		<div class="page-content--bgf7">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<br>
						<h3 class="title-5 m-b-35">Cidades </h3>
							...
							<div class="table-data__tool-right">
								<form action="cadastrarCidade">
									<button type="submit"
										...
										<i class="zmdi zmdi-plus"></i>Nova cidade
									</button>
								</form>
						...
						<div class="table-responsive table-responsive-data2"
							...
							<table class="table table-data2">
								...
								<tbody id="tbCidade">
									<c:forEach var="cidade" items="${listarCidades}">
										<tr class="tr-shadow">

											<td width="180">${cidade.nome}</td>
											
											<td><span>${cidade.estado.nome}</span></td>

											<td><span>${cidade.estado.uf}</span></td>
												...
												<td><div class="table-data-feature">
													...
													<a href="editarEstado?id=${cidade.idCidade}" class="item" data-toggle="tooltip"
													...
													<a href="deleteEstado?id=${cidade.idCidade}"  class="item" data-toggle="tooltip"
