...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/prestador/cadastroPrestadorJuridico.js"></script>
...
$(document).ready(function(){
	$("#form_cadastroJuridico").submit(function() {
	     
		 if($("input[required='required']").val() != "" && $("select[required='required']").val() != "" ){
	          
			   var celular = $("#celular").val();
			   var area = $("#atuacao").val();
	           var cpfCnpj= $("#cpfCnpj").val();
	           var dataNascimento= "10/10/2000";
			...
			<div class="login-content" style="width: 600px; margin:0 auto; float: none;">
				...
				<div style="margin-bottom: 20px;">
						<center>Olá ${usuarioLogado.nome}! Antes de ter acesso ao
							sistema informe algumas informações da sua Empresa no formulario abaixo.</center>
				</div>

				<!-- Formulário de cadastro-->

				<div class="login-form">
					<form id="form_cadastroJuridico" >
												
					<div class="row">	
						<div class="col-md-12 col-lg-12">
							<div class="form-group" >
								<label>Nome da empresa</label> <input id="nomeFantasia" required="required"
									class="form-control" type="text" name="nomeFantasia"
					...
					<div class="row">	
						<div class="col-md-12 col-lg-12">
							<div class="form-group" >
								<label>Área de Atuação</label> <select required="required" id="atuacao"
                     ...
                     <div class="row">
						<div class="col-md-6 col-lg-6" >
							<div class="form-group">
								<label for="cpf">CNPJ:</label> <input type="text"
									class="form-control" id="cpfCnpj" placeholder="Digite o CNPJ"
									name="cpfCnpj">
							</div>
						</div>
						...
						<div class="col-md-6 col-lg-6" >
							<div class="form-group">
								<label for="rg">Inscrição Estadual:</label> <input type="text" required="required";
									class="form-control" id="rgIe" placeholder="Digite a Inscrição Estadual"
									name="rgIe">
					        </div>
					    </div>
					</div>
					...
					<div class="row">	
						<div class="col-md-12 col-lg-12">
							<div class="form-group" >
								<label>Razão Social</label> <input id="razaoSocial" required="required"
						...
						<div class="col-md-6 col-lg-6" >
							<div class="form-group" >
								<label for="telefone">Número Telefone fixo :</label> <input
									type="text" class="form-control" id="telefone" required="required"
